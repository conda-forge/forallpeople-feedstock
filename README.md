...
<table><tr>
    <td>All platforms:</td>
    <td>
      <a href="https://github.com/conda-forge/forallpeople-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/forallpeople-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
</table>
...
pixi add forallpeople
# for installing globally
pixi global install forallpeople
```
...
It is possible to list all of the versions of `forallpeople` available on your platform:
...
```
pixi search forallpeople --channel conda-forge
```
